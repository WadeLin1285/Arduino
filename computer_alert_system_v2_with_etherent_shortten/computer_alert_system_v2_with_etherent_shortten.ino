...
byte server[] = { 34 , 204 , 223 , 66}; // maker.ifttt.com
...
/*
  ...
  if (myFile) {
    Serial.println("Reading Machine document file...");
    // read the SD card information
    char line[1];
    while()
    // close the file:
    Machine_document.close();
  } else {
    // if the file didn't open, print an error:
    Serial.println("error opening Machine_document.txt");
  }*/
}
...
void loop() {
  ...
  if (key == 'A') Alert("NCKU","001","Door Open");
